...
class ECRTM(nn.Module):
    ...
    def __init__(self, vocab_size, num_topics=50, en_units=200, dropout=0., pretrained_WE=None, embed_size=200, 
                 beta_temp=0.2, weight_loss_ECR=100.0, sinkhorn_alpha=20.0, sinkhorn_max_iter=1000, OT_max_iter=1000,
                 stopThr=0.005, alpha_noise=0.01, alpha_augment=0.05, num_clusters=30,
